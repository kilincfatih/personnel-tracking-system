...
public class UserDAO extends DBConnection {
    ...
    public SystemUser getUser(String email, String pass) {
        ...
        try {
            ...
            String query = "select * from systemuser where email='" + email + "' and pass='" + pass + "'";
    ...
    public List<SystemUser> getList(int page) {
        List<SystemUser> list = new ArrayList<>();
        int offset = (page - 1) * 5;
        try {
            Statement st = this.getConnect().createStatement();
            String query = "select * from systemuser order by id asc limit 5 offset" + offset;
