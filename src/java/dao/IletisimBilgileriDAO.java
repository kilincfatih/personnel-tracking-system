...
public class IletisimBilgileriDAO extends DBConnection {
    ...
    public void update(IletisimBilgileri k) {
        ...
        try {
            Statement st = this.connect().createStatement();
            String query = "update iletisim_bilgileri set iletisim_bilgiler_tc ='" + k.getTc() + "', telefon_no='" + k.getTelefonNo() + "', mail_adresi='" + k.getMailAdresi() + "', posta_kodu='" + "' where id=" + k.getId();
